...
<div class="container">
    ...
    <div class="card card-body mx-3 mx-md-4 mt-n6">
            ...
            <div class="col">
                <div class="card card-plain h-100">
                    ...
                    <div class="card-body p-3">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Name: {{ $users->name }}</strong></li>
                            <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Position: {{ $users->email }}</strong></li>
        ...
        <div class="col-lg-6">
        <a href="{{ route('admins.index') }}" class="btn btn-danger w-50 mt-2">Back</a>
        <a href="{{ route('admins.edit', $users->id) }}" class="btn btn-primary w-50">Edit Profile</a>
    </div>
    </div>
</div>
@endsection
