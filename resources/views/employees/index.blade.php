                        ...
                        <tr>
                            <td>
                                <div class="d-flex px-2 py-1">
                                    <img src="{{ asset('profile-photos/' . $item->profile_photo_path) }}" alt="{{ $item->name }}'s Profile Photo" class="img-thumbnail">
                                </div>
                            </td>
                            <td>
                                <div class="d-flex px-2 py-1">
                            ...
                            <td>
                                <div class="d-flex px-2 py-1">
                                    <h6 class="mb-0 text-sm">{{ $item->country }}</h6>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex px-2 py-1">
                                    <h6 class="mb-0 text-sm">{{ $item->postal_code }}</h6>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex px-2 py-1">
                                    <h6 class="mb-0 text-sm">{{ $item->about }}</h6>
                                </div>
                            </td>
                            <td>
